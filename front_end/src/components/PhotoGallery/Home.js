...
export function getdata(photoID1) {
  ...
  axios.post("http://localhost:4000/search", k)
  .then((response)=>{
    data = response.data
...
export default function TitlebarBelowMasonryImageList() {
  ...
  return (
    <Box style={{backgroundColor: "lightgray", height: "auto",  padding: "20px" , width: "auto"}}>
      <Grid container onClick={HandleClick} align="center" className="ImageText" id="Gallery" variant="quilted" gap={5}>
        <Grid item xs={12} style={{textAlign: "center", display: "block", height:"100vh"}}>
          <h1 style={{textAlign: "center", fontFamily: "cursive", color: "blue"}}>Welcome to Image Gallery</h1>
          <h3 style={{textAlign: "center",fontFamily: "cursive"}}>By Nitin Patel</h3>
        </Grid>
      </Grid>
      <Modal
        open={open}
        ...
        <Box id="modal" sx={style} overflow="scroll">
          ...
          <Grid gap={0} container width="400px">
            <Grid item xs={12} id="modal-modal-title">
              <h1 style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "center"}}>Name: {first_name}  {last_name}</h1>
            </Grid>
            <Grid item xs={6} style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "center"}} id="modal-modal-description">
              Likes: {total_likes}
            </Grid>
            <Grid item xs={6} style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "center"}} id="modal-modal-description">
              Total Photoes: {totalphotos}
            </Grid>
            <Grid item xs={12} style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "center"}} id="modal-modal-description">
            <h1 style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "center"}}>Social Links</h1>
            </Grid>
            <Grid item xs={12} style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "start"}} id="modal-modal-description">
              username: {username}
            </Grid>
            <Grid item xs={12} style={{fontFamily: "monospace", fontWeight: "bolder", textAlign: "start"}} id="modal-modal-description">
              Instagram: {instagram}
